      ...
      <div class='bit-1 box'>
          ...
          <div class='club'>
            <div class='club-info bit-60'>
              <h1><?=$this->data['club']->clubname;?> <?if(PRO::is_pro($this->data['club']->id_club)){?><img width='20px' src='<?=$this->tree?>assets/img/icons/coin.png'> <small class='pro'>PRO</small><?}?> <?if($this->data['club']->status=='I'){ echo '<strong><span class="blue">(INATIVO)</span></strong>';}?><? if($this->data['club']->status=='B'){ echo '<strong><span class="red">(BANIDO)</span></strong>';}?> <? if($this->data['clubinfo']->nickname!=null and $this->data['club']->status=='A'){?><span class='nickname'>[<?=$this->data['clubinfo']->nickname;?>]<?}?></span><img class='country-icon' src='<?=$this->tree?>assets/img/icons/flags/<?=$this->data['club']->country['country']?>.png' width="30px"></h1>
