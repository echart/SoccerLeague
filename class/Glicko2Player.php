...
class Glicko2Player {
	...
	function __construct($rating = 20, $rd = 5, $volatility = 0.06, $mu = null, $phi = null, $sigma = null, $systemconstant = 0.75) {
		// Step 1
		$this->rating = $rating;
		$this->rd = $rd;
		// volatility
	...
	$Charlie->Update();
	$David->Update(); // David did not participate, but must be updated
	echo $Alice->rating."<br>";
	echo $Bob->rating."<br>";
	echo $Charlie->rating."<br>";
	echo $David->rating."<br>";
