...
class PlayerFactory{
    ...
    $player->injury_prop=PlayerFactory::random(1,20.0);
    $player->professionalism=PlayerFactory::random(1,20.0);
    $player->agressive=PlayerFactory::random(1,20.0);
    $player->adaptability=PlayerFactory::random(1,20.0);
    $player->leadership=PlayerFactory::random(1,20.0);
